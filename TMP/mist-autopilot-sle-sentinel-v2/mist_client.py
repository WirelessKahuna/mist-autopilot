...
class MistClient:
    ...
    async def get_site_sle_metric(
        ...
        Correct endpoint: /api/v1/sites/{site_id}/sle/{scope}/{metric}/summary
        scope  : "wireless" | "wired" | "wan"
        metric : e.g. "wifi-coverage", "ap-availability", "wan-availability"
        duration: "1d" | "7d" | "30d"
        """
        return await self.get(
            f"/api/v1/sites/{site_id}/sle/{scope}/{metric}/summary",
